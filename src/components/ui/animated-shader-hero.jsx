...
const Hero = ({
  ...
  return (
    <div 
      className={`relative w-full min-h-[85vh] sm:min-h-screen flex items-center justify-center overflow-hidden bg-black/0 -mb-px pt-20 sm:pt-24 md:pt-28 lg:pt-32 ${className}`}
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-white w-full px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12 lg:py-16">
        ...
        <div className="text-center space-y-4 sm:space-y-6 md:space-y-8 lg:space-y-10 max-w-6xl mx-auto w-full">
          {/* Main Headline - IEEE Separated and Prominent */}
          <div className="space-y-2 sm:space-y-3 md:space-y-4 lg:space-y-6">
            {/* IEEE - Large and Minimal */}
            {headline?.line1 && (
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-[10rem] font-black text-white leading-[1.1] tracking-tight px-2">
                {headline.line1}
              </h1>
            )}
            ...
            {headline?.line2 && (
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold text-white animate-slide-in-left animation-delay-400 leading-[1.1] tracking-tight px-2">
                {headline.line2}
              </h1>
            )}
          </div>
          ...
          {subtitle && (
            <div className="max-w-4xl mx-auto px-3 sm:px-4">
              <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-white/90 font-medium leading-relaxed relative inline-block animate-slide-in-right animation-delay-600">
