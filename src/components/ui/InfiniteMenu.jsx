...
// Shader sources and classes remain the same as provided
...
class InfiniteGridMenu {
  ...
  #animate(deltaTime) {
    ...
    positions.forEach((p, ndx) => {
      ...
      const translateToOrigin = mat4.fromTranslation(mat4.create(), vec3.negate(vec3.create(), p));
      const lookAtMatrix = mat4.create();
      mat4.lookAt(lookAtMatrix, [0, 0, 0], p, [0, 1, 0]);
      mat4.invert(lookAtMatrix, lookAtMatrix);
      const scaleMatrix = mat4.fromScaling(mat4.create(), [finalScale, finalScale, finalScale]);
      const translateBack = mat4.fromTranslation(mat4.create(), [0, 0, -this.SPHERE_RADIUS]);
      mat4.multiply(matrix, translateToOrigin, lookAtMatrix);
      mat4.multiply(matrix, matrix, scaleMatrix);
      mat4.multiply(matrix, matrix, translateBack);
  ...
  #updateCameraMatrix() {
    mat4.lookAt(this.camera.matrix, this.camera.position, [0, 0, 0], this.camera.up);
